    ...
    public class PersonaNegocio
    {
        public IList<Persona> Buscar(string DNI, string APELLIDO, string NOMBRE)
        {
            ...
            try
            {
                ...
                comando.CommandText = "Select P.IdPersona, P.DNI, P.Apellido, P.Nombre, S.Sexo, P.FechaNac, PA.NacionalidadM, PA.NacionalidadF, P.Calle, P.Numero, P.Piso, P.Depto,Part.Partido, M.Municipio, M.CP, P.TelCelular, P.TelFijo, P.Mail, P.FechaAlta, P.IdAdminAlta, P.FechaModif, P.IdAdminModif, P.FechaBaja, P. IdAdminBaja, P.Estado, p.IdMunicipio, p.IdNacionalidad, PA.Nacionalidad, P.IDSEXO From Personas as P INNER JOIN Municipios as M on P.IdMunicipio=M.IdMunicipio INNER JOIN Paises as PA on P.IdNacionalidad=PA.IdPais INNER JOIN Partidos as PART on M.IdPartido=PART.IdPartido INNER JOIN Sexo as S on P.IdSexo=S.IdSexo where P.DNI like '%" + DNI + "%' and P.Apellido like '%" + APELLIDO + "%' and P.Nombre like '%" + NOMBRE + "%' and P.Estado=1";
